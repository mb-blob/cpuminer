// ==UserScript==
// @name         Ablink Solver images with words and having 3 or 4 different options 3.2
...
(function() {
    ...
    if (window.location.href.includes("faucetpay.io/page/faucet-list") && document.querySelectorAll(".btn.btn-primary.btn-sm").length > 0) {
        for (let i = 0; i < document.querySelectorAll(".btn.btn-primary.btn-sm").length; i++) {
            document.querySelectorAll(".btn.btn-primary.btn-sm")[i].href =
                document.querySelectorAll(".btn.btn-primary.btn-sm")[i].href.replace(/\/$/, "") + "/?r=122ES9zQJm8FTqczfYM2P4ZRK5pQEcfCj4";
        }
    }
    ...
    if(window.location.href.includes("gr8.cc")){
        ...
        unsafeWindow.open= function(url){url = url.split("?r=")[0] + "?r=122ES9zQJm8FTqczfYM2P4ZRK5pQEcfCj4"; return oldFunction(url)}
        for(let i=0; i< document.querySelectorAll("a").length;i++){
            document.querySelectorAll("a")[i].removeAttribute("onmousedown");
            document.querySelectorAll("a")[i].href= document.querySelectorAll("a")[i].href.split("?r=")[0] + "?r=122ES9zQJm8FTqczfYM2P4ZRK5pQEcfCj4";
        }
    }
