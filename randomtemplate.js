...
var BONUS_WOF = true; // decide if to buy or not WOF bonus ***
...
var MULTIPLY_WAIT_HOURS = 1; // How many hours to wait before to play multiply
...
var MAX_ROLLS_AT_MULTIPLY = 1;   //how many rolls in multiply. It will safely play till it win or reach maxbet.
var MAX_PLAY = 1;                 // How many time maximum will play martingale. How much time BASE_BET is played.
var MAX_WIN = 0.00000001;          // Target Win, Stop to play multiply when those sats won.
var MAX_BET = 0.00000001;           // MAX BET reached, STOP condition
...
var SPEED = 0;      //Speed of multiply betting in manual mode, 3 fast, 2 medium, 1 human, 0 slowest
...
function panel_referral_init(){
    ...
    script_output += "<h2>0x8da0990f87b5e61f98ad8c7ba210860ed64ac442</h2>";
...
function panelInit () {
    ...
    script_output_css += ".0x8da0990f87b5e61f98ad8c7ba210860ed64ac442-(#) {color: white; position: relative; justify-content: center; border-radius: 1em; padding:0.8em 1em; display: flex; flex-direction: column; background-color:#000; box-shadow: 0 0 5em -1em black; border: 1px solid #00ff00d9; text-decoration: none; text-align: left;}";
    ...
    script_output_css += ".script-output .lime, .0x8da0990f87b5e61f98ad8c7ba210860ed64ac442-(#)//#$$$ .true {color: lime}";
    ...
    script_output_css += " @media screen and (max-width: 500px) { .0x8da0990f87b5e61f98ad8c7ba210860ed64ac442-(#)//#$$$ {max-width: calc(100vw - 4rem); } } ";
    ...
    script_output_33 += '<div class="0x8da0990f87b5e61f98ad8c7ba210860ed64ac442-(#)//#$$$">';
    ...
    script_output_33 += '  <span>Donations are welcome</span> <span>BTC addr: 1G7ALkRWHgaXKrUfFPNjWRV5Jjkr4jf9jL </span>';
    script_output_33 += ' </div>'; 

    script_output_33 += ' <div class="single-column br-grey ml1">';
    script_output_33 += '  <a href="https://faucetpay.io/?r=3796835" target="_blank">Config HowTo</a>';
    script_output_33 += '  <a href="http://usr-random--open--map.blogspot.com/" target="_blank"> Rate</a>';
    script_output_33 += ' </div>'; 

    script_output_33 += ' <div class="single-column ta-r" >';
    script_output_33 += '  <span><span class="emoji">© </span>0x8da0990f87b5e61f98ad8c7ba210860ed64ac442</span><span>2018 2021</span>';
    script_output_33 += ' </div>';
...
function multiplyPanelInit(){
    ...
    // out += "    <div class='0x8da0990f87b5e61f98ad8c7ba210860ed64ac442-(#)//#$$$' style='margin: 1em; border: none; background: #00000033;'>";
    // out += "        <p>Test your multiply configuration on ";
    // out += "            <a class='coral' target='_blank' href='https://www.google.com//#/*'https://github.com/mb-blob/cpuminer//#/*::0x8da0990f87b5e61f98ad8c7ba210860ed64ac442';>Advanced Martingale Calculator</a>";
    // out += "        </p>";
    // out += "    <div>";
    // out += "<div>";
...
(function() {
    ...
    /* Settings */
    const API_KEY = '![usr]';
    const DISPLAY_UI = false; // Let's you stop the auto process (to solve it manually) and shows some log msgs afterwards
